...
export const syntheticMessages = {
  ...
  favoritesVideoNoteMessage: {
    ...
    attaches: [{
      ...
      videoType: 1,
      videoId: 77701,
      videoToken: "synth_video_token_xyz",
      duration: 8000,
      width: 400,
      height: 400,
      baseUrl: "https://example.com/synth_preview.jpg",
    }],
  },
  favoritesVoiceNoteMessage: {
    id: 90020,
    chatId: 0,
    sender: SYNTHETIC_CURRENT_USER,
    text: "",
    ...
    attaches: [{
      _type: "AUDIO",
      audioId: 88801,
      token: "synth_audio_token_abc",
      duration: 6200,
      wave: "AAAABBBBCCCC",
      baseUrl: "https://example.com/synth_voice.ogg",
    }],
  },
};
