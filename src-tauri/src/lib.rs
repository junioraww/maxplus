...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            stores::get_device,
            stores::save_device,
            stores::webapp_storage_save_key,
            stores::webapp_storage_get_key,
            stores::webapp_storage_clear,
            stores::webapp_storage_get_keys,
            stores::webapp_biometry_get,
            stores::webapp_biometry_set,
